...
return $this->services['nelmio_api_doc.generator'] = new \Nelmio\ApiDocBundle\ApiDocGenerator(new RewindableGenerator(function () {
    ...
    yield 1 => ${($_ = isset($this->services['nelmio_api_doc.model_describers.object']) ? $this->services['nelmio_api_doc.model_describers.object'] : $this->load('getNelmioApiDoc_ModelDescribers_ObjectService.php')) && false ?: '_'};
}, 2));
