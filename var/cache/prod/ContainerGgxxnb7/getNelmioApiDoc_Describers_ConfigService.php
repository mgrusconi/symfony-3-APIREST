...
return $this->services['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(array('info' => array('title' => 'Craft API REST', 'description' => 'Reception and processing of Leads', 'version' => 'v1.0.0'), 'schemes' => array(0 => 'http', 1 => 'https')));
