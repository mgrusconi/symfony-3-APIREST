...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Resources/views'), '!NelmioApiDoc');
        $instance->addPath(($this->targetDirs[3].'/src/Application/SomeBundle/Resources/views'), 'Some');
        $instance->addPath(($this->targetDirs[3].'/src/Application/SomeBundle/Resources/views'), '!Some');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'SomeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Application/SomeBundle'),
                    'namespace' => 'Application\\SomeBundle',
                ),
            ); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SomeBundle' => 'Application\\SomeBundle\\SomeBundle',
            ),
