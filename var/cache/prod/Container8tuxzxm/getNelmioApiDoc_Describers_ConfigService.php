...
return $this->services['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(array('info' => array('title' => 'API REST', 'description' => 'Documentation EndPoint API', 'version' => 'v1.0.0'), 'schemes' => array(0 => 'http', 1 => 'https')));
